...
namespace NativeJIT
{
    ...
    class ExpressionNodeFactory2 : public ExpressionTree
    {
    public:
        ExpressionNodeFactory2(Allocators::IAllocator& allocator, FunctionBuffer& code);
    ...
    //*************************************************************************
    //
    // Template definitions for ExpressionNodeFactory2.
    //
    //*************************************************************************
    ...
    //
    template <typename T>
    Node<T>& ExpressionNodeFactory2::Immediate(T value)
    {
    ...
    template <typename T>
    ParameterNode<T>& ExpressionNodeFactory2::Parameter()
    {
    ...
    //
    template <typename T>
    Node<T>& ExpressionNodeFactory2::Deref(Node<T*>& pointer)
    {
    ...
    Node<FIELD*>& ExpressionNodeFactory2::FieldPointer(Node<OBJECT*>& object, FIELD OBJECT::*field)
    {
    ...
    template <typename T>
    NodeBase& ExpressionNodeFactory2::Return(Node<T>& value)
    {
    ...
    Node<L>& ExpressionNodeFactory2::Add(Node<L>& left, Node<R>& right)
    {
    ...
    template <typename L, typename R>
    Node<L>& ExpressionNodeFactory2::Mul(Node<L>& left, Node<R>& right)
    {
    ...
    Node<T*>& ExpressionNodeFactory2::Add(Node<T*>& array, Node<INDEX>& index)
    {
    ...
    ExpressionNodeFactory2::GreaterThan(Node<T>& left, Node<T>& right)
    {
    ...
    //
    template <typename T, JccType JCC>
    Node<T>& ExpressionNodeFactory2::Conditional(FlagExpressionNode<JCC>& condition,
                                                Node<T>& left,
                                                Node<T>& right)
    {
    ...
    //
    template <typename R, typename P1, typename P2>
    Node<R>& ExpressionNodeFactory2::Call(Node<R (*)(P1,P2)>& function,
                                         Node<P1>& param1,
                                         Node<P2>& param2)
    {
    ...
    Node<L>& ExpressionNodeFactory2::Binary(Node<L>& left, Node<R>& right)
    {
